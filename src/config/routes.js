...
const OfficeManagement = lazy(() => import('../pages/super-admin/OfficeManagement'));
const CreateOffice = lazy(() => import('../pages/super-admin/CreateOffice'));
const EditOffice = lazy(() => import('../pages/super-admin/EditOffice'));
const StaffManagement = lazy(() => import('../pages/super-admin/StaffManagement'));
...
const LeadDistributionRules = lazy(() => import('../pages/super-admin/LeadDistributionRules'));
const UniversityManagement = lazy(() => import('../pages/super-admin/UniversityManagement'));
const CourseManagement = lazy(() => import('../pages/super-admin/CourseManagement'));
const GlobalLeadManagement = lazy(() => import('../pages/super-admin/GlobalLeadManagement'));
const SystemSettings = lazy(() => import('../pages/super-admin/SystemSettings'));
const LeadManagement = lazy(() => import('../pages/super-admin/LeadManagement'));
...
const ConsultantPerformance = lazy(() => import('../pages/manager/ConsultantPerformance'));
...
const StudentProfiles = lazy(() => import('../pages/consultant/StudentProfiles'));
const AppointmentManagement = lazy(() => import('../pages/consultant/AppointmentManagement'));
const DocumentCollection = lazy(() => import('../pages/consultant/DocumentCollection'));
const CommunicationHistory = lazy(() => import('../pages/consultant/CommunicationHistory'));
const TaskManagement = lazy(() => import('../pages/consultant/TaskManagement'));
const ApplicationProgress = lazy(() => import('../pages/consultant/ApplicationProgress'));
const MeetingScheduler = lazy(() => import('../pages/consultant/MeetingScheduler'));

const ReceptionistDashboard = lazy(() => import('../pages/receptionist/ReceptionistDashboard'));
const WalkInRegistration = lazy(() => import('../pages/receptionist/WalkInRegistration'));
const AppointmentBooking = lazy(() => import('../pages/receptionist/AppointmentBooking'));
const ConsultantCalendars = lazy(() => import('../pages/receptionist/ConsultantCalendars'));
const ContactManagement = lazy(() => import('../pages/receptionist/ContactManagement'));
const WaitingList = lazy(() => import('../pages/receptionist/WaitingList'));
const AppointmentConfirmations = lazy(() => import('../pages/receptionist/AppointmentConfirmations'));
...
const StudentAppointmentBooking = lazy(() => import('../pages/student/AppointmentBooking'));
const CommunicationCenter = lazy(() => import('../pages/student/CommunicationCenter'));
const TaskChecklist = lazy(() => import('../pages/student/TaskChecklist'));
const DeadlineCalendar = lazy(() => import('../pages/student/DeadlineCalendar'));
const MeetingJoin = lazy(() => import('../pages/student/MeetingJoin'));
const ApplicationSummary = lazy(() => import('../pages/student/ApplicationSummary'));
