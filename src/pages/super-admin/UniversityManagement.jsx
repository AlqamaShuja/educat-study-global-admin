...
const UniversityManagement = () => {
  ...
  const getPercentageBadgeColor = (percentage) => {
    ...
    if (percent >= 5) return "bg-yellow-100 text-yellow-800";
          ...
          <div className="bg-white rounded-lg border p-3">
            ...
            <div className="text-2xl font-bold text-blue-600">
              {universities?.length > 0
                ? (
                    universities.reduce(
                      (sum, u) => sum + parseFloat(u.percentageAgreed || 0),
                      0
                    ) / universities.length
                  ).toFixed(1)
                : 0}
                  ...
                  <tr key={university.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-1">
                        ...
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getPercentageBadgeColor(
                            university.percentageAgreed
                          )}`}
                        >
                          {university.percentageAgreed || 0}%
                        </span>
                      </div>
                    </td>
