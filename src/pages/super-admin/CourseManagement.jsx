...
const CourseManagement = () => {
  ...
  const handleOpenAssignModal = (course) => {
    ...
    setSelectedUniversityId(course.universityId || "");
  ...
  // Get unique levels and universities for filters
  const uniqueLevels = [
    ...new Set(courses?.map((c) => c.level)?.filter(Boolean)),
  ];
  const uniqueUniversities = [
    ...new Set(courses?.map((c) => c.universityId)?.filter(Boolean)),
  ];
  ...
  const filteredCourses = courses?.filter((course) => {
    ...
    const matchesUniversity =
      !universityFilter || course.universityId === universityFilter;

    let matchesAssignment = true;
    if (assignmentFilter === "assigned") {
      matchesAssignment = !!course.universityId;
    } else if (assignmentFilter === "unassigned") {
      matchesAssignment = !course.universityId;
    }

    return (
      matchesSearch && matchesLevel && matchesUniversity && matchesAssignment
    );
  });
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage courses, assignments, and university partnerships
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <div className="bg-white rounded-lg border p-3">
            ...
            <div className="text-2xl font-bold text-green-600">
              {courses?.filter((c) => c.universityId)?.length}
            </div>
          </div>
          <div className="bg-white rounded-lg border p-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div>
            ...
            >
              ...
              {uniqueUniversities?.map((universityId) => {
        ...
        {filteredCourses?.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600">
              {searchTerm || levelFilter || universityFilter || assignmentFilter
                  ...
                  <tr key={course.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-1 text-sm text-gray-900">
                        ...
                        <span
                          className={
                            course.universityId ? "" : "text-orange-600"
                          }
                        >
                      ...
                      <div className="space-y-1">
                        ...
                        {course.tuitionFee && (
                          <div className="flex items-center gap-1">
                            ...
                            {parseFloat(course.tuitionFee).toLocaleString()}
                          </div>
                        )}
                      </div>
                    </td>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="text-sm text-gray-600">
              ...
              <div>
                <strong>Level:</strong> {getLevelLabel(selectedCourse?.level)}
              </div>
              <div>
                <strong>Current Assignment:</strong>{" "}
                {getUniversityName(selectedCourse?.universityId)}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            >
              <option value="">Unassign from university</option>
          ...
          <div className="flex justify-end space-x-3 pt-4 border-t">
            ...
            <Button
              ...
              loading={formLoading}
            >
              {selectedUniversityId ? "Assign University" : "Remove Assignment"}
            </Button>
          </div>
        </div>
      </Modal>
