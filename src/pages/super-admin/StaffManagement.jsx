...
const StaffManagement = () => {
  ...
  // Updated handleViewStaffDetails function to match the second file's functionality
  const handleViewStaffDetails = (staff) => {
    navigate(`/super-admin/staff/details/${staff.id}`, { state: { staff } });
  };
  ...
  const getStatusBadgeColor = (status) => {
    console.log(status, "sacacannjnacscsansa");
...
//                           variant="outline"
//                           size="sm"
//                           onClick={() => handleViewStaffDetails(member.id)}
//                           className="flex items-center gap-1"
//                         >
//                           <Eye className="h-3 w-3" />
//                           View
