...
const OAuthButtons = ({
  ...
  const { googleLogin, facebookLogin, githubLogin, isLoading, error } =
    useAuthStore();
  ...
  const oauthProviders = [
    {
      name: "Google",
      icon: GoogleIcon,
      onClick: () => handleOAuthLogin("Google", googleLogin),
      className:
    ...
    },
    {
      name: "Facebook",
      icon: FacebookIcon,
      onClick: () => handleOAuthLogin("Facebook", facebookLogin),
    ...
    },
    {
      name: "GitHub",
      icon: GitHubIcon,
      onClick: () => handleOAuthLogin("GitHub", githubLogin),
      className: "border-gray-900 bg-gray-900 hover:bg-gray-800 text-white",
      disabled: disabled || isLoading,
    },
  ];
